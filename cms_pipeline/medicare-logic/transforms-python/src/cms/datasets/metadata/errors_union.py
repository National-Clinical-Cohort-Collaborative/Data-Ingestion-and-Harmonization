...
inputs = {ds.name: Input(configs.transform + "01 - parsed/errors/" + ds.name) for ds in configs.datasets}


@transform_df(
    Output("ri.foundry.main.dataset.473fcd22-0be5-46b5-a9bd-7982323681cd"),
    **inputs
)
