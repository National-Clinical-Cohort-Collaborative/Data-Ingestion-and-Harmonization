...
exceptions = {
    "care_site": configs.metadata + "care_site_marking_removed",
    "health_system": configs.metadata + "health_system_marking_removed",
}

# Use the dictionary comprehension with a conditional check for exceptions
inputs = {
    domain + "_in": Input(exceptions[domain] if domain in exceptions else configs.transform + '06_5 - add concept name/' + domain)
