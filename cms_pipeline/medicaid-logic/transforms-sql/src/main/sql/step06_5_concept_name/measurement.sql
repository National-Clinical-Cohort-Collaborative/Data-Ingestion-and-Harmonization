CREATE TABLE `/UNITE/[PPRL] CMS Data & Repository/medicaid/pipeline/transform/06_5 - add concept name/measurement` AS
    SELECT m.*, 
    c.concept_name as measurement_concept_name, cs.concept_name as measurement_source_concept_name
    FROM `/UNITE/[PPRL] CMS Data & Repository/medicaid/pipeline/transform/06 - schema check/measurement` m
