...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/final/payer_plan_period'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/06 - id generation/payer_plan_period',
        checks=[
            Check(E.primary_key('payer_plan_period_id'), 'Valid primary key', on_error='FAIL'),
            ...
            Check(E.col('payer_plan_period_start_date').non_null(), 'payer_plan_period_start_date column contains null', on_error='WARN'),
            Check(E.col('payer_plan_period_end_date').non_null(), 'payer_plan_period_end_date column contains null', on_error='WARN'),
        ]
    ),
)
