...
@transform(
    processed=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/condition'),
    my_input=Input('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/condition'),
...
def compute_function(my_input, site_id_df, mapping_table, processed):
    ...
    processed_df = add_mapped_vocab_code_col(
        ...
        domain="CONDITION",
        source_vocab_col="condition_type",
        mapped_col_name="mapped_condition_type"
    )
