...
@transform(
    processed=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/demographic'),
    my_input=Input('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/demographic'),
...
def compute_function(my_input, site_id_df, processed):
    ...
    processed_df = create_datetime_col(processed_df, "birth_date", "birth_time", "BIRTH_DATETIME")
