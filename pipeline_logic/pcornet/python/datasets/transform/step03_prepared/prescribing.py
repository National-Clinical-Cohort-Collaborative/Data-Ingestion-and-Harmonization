...
@transform(
    processed=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/prescribing'),
    my_input=Input('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/prescribing'),
...
def compute_function(my_input, site_id_df, processed):
    ...
    processed_df = create_datetime_col(processed_df, "rx_order_date", "rx_order_time", "RX_ORDER_DATETIME")
