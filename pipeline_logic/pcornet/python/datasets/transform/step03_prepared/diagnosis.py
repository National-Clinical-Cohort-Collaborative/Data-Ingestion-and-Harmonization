...
@transform(
    processed=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/diagnosis'),
    my_input=Input('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/diagnosis'),
...
def compute_function(my_input, site_id_df, mapping_table, processed):
    ...
    processed_df = add_mapped_vocab_code_col(
        ...
        domain="DIAGNOSIS",
        source_vocab_col="dx_type",
        mapped_col_name="mapped_dx_type"
    )
