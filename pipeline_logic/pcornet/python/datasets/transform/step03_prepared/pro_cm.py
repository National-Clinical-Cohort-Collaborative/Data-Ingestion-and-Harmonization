...
@transform(
    processed=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/pro_cm'),
    my_input=Input('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/pro_cm'),
...
def compute_function(my_input, site_id_df, processed):
    ...
    processed_df = create_datetime_col(processed_df, "pro_date", "pro_time", "PRO_DATETIME")
