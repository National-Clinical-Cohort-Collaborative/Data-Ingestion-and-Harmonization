...
@transform(
    processed=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/immunization'),
    my_input=Input('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/immunization'),
...
def compute_function(my_input, site_id_df, mapping_table, processed):
    ...
    processed_df = add_mapped_vocab_code_col(
        ...
        domain="IMMUNIZATION",
        source_vocab_col="vx_code_type",
        mapped_col_name="mapped_vx_code_type"
    )
