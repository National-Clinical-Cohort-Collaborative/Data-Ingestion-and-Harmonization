...
@transform(
    processed=Output(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/lab_result_cm',
        checks=[
            Check(E.primary_key('lab_result_cm_id'), 'Valid cleaned primary key', on_error='WARN')
        ]
    ),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/01 - parsed/lab_result_cm',
        checks=[
            ...
            Check(E.any(E.primary_key('LAB_RESULT_CM_ID'), E.primary_key('lab_result_cm_id')), 'Valid parsed primary key', on_error='WARN')
        ]
    ),
)
