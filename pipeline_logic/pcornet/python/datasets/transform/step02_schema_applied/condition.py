...
@transform(
    processed=Output(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/condition',
        checks=[
            Check(E.primary_key('conditionid'), 'Valid cleaned primary key', on_error='WARN')
        ]
    ),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/01 - parsed/condition',
        checks=[
            ...
            Check(E.any(E.primary_key('CONDITIONID'), E.primary_key('conditionid')), 'Valid parsed primary key', on_error='WARN')
        ]
    ),
)
