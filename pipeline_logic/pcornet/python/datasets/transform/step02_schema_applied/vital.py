...
@transform(
    processed=Output(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/vital',
        checks=[
            Check(E.primary_key('vitalid'), 'Valid cleaned primary key', on_error='WARN')
        ]
    ),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/01 - parsed/vital',
        checks=[
            ...
            Check(E.any(E.primary_key('VITALID'), E.primary_key('vitalid')), 'Valid parsed primary key', on_error='WARN')
        ]
    ),
)
