...
@transform(
    processed=Output(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/procedures',
        checks=[
            Check(E.primary_key('proceduresid'), 'Valid cleaned primary key', on_error='WARN')
        ]
    ),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/01 - parsed/procedures',
        checks=[
            ...
            Check(E.any(E.primary_key('PROCEDURESID'), E.primary_key('proceduresid')), 'Valid parsed primary key', on_error='WARN')
        ]
    ),
)
