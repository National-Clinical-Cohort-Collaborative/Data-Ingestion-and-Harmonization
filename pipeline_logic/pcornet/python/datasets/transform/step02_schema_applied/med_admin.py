...
@transform(
    processed=Output(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/med_admin',
        checks=[
            Check(E.primary_key('medadminid'), 'Valid cleaned primary key', on_error='WARN')
        ]
    ),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/01 - parsed/med_admin',
        checks=[
            ...
            Check(E.any(E.primary_key('MEDADMINID'), E.primary_key('medadminid')), 'Valid parsed primary key', on_error='WARN')
        ]
    ),
)
