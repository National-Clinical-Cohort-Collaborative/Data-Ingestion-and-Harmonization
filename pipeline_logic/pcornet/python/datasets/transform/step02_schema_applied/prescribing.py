...
@transform(
    processed=Output(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/02 - clean/prescribing',
        checks=[
            Check(E.primary_key('prescribingid'), 'Valid cleaned primary key', on_error='WARN')
        ]
    ),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/01 - parsed/prescribing',
        checks=[
            ...
            Check(E.any(E.primary_key('PRESCRIBINGID'), E.primary_key('prescribingid')), 'Valid parsed primary key', on_error='WARN')
        ]
    ),
)
