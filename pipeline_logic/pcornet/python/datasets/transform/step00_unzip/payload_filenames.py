...
from pcornet.utils import get_newest_payload
...
@transform(
    payload_filename=Output("/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/00 - unzipped/payload_filename"),
    zip_file=Input("/UNITE/Data Ingestion & OMOP Mapping/raw_data/Zipped Datasets/site_793_pcornet_raw_zips"),
)
