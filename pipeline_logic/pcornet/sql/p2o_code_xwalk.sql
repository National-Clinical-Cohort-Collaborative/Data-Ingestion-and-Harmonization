CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/p2o_code_xwalk` AS
...
WITH site_codes_to_source_concept_mapping AS (
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/procedures` p
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/condition` cd
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/death_cause`dt
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/lab_result_cm` l
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/dispensing` dx
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/prescribing` p
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/obs_clin` o
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/immunization` i
        LEFT JOIN `/UNITE/OMOP Vocabularies/concept` c
