CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/04 - domain mapping/visit_occurrence` AS
...
-- encounter
    SELECT 
        ...
        data_partner_id,
        payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 793/transform/03 - prepared/encounter` enc
        LEFT JOIN `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: ACT/Reference Tables/visit_xwalk_table` vx 
            ...
            AND vx.SRC_VISIT_TYPE = trim(enc.enc_type)
