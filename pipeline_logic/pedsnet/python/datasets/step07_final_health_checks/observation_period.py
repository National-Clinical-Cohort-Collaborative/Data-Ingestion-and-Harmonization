...
all_checks = [
    Check(E.primary_key('observation_period_id'), 'Valid global id primary key', on_error='FAIL'),
...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/final/observation_period'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/06 - global id generation/observation_period',
        checks=all_checks
    ),
)
