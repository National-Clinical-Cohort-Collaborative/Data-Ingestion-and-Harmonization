...
all_checks = [
    Check(E.primary_key('observation_id'), 'Valid global id primary key', on_error='FAIL'),
...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/final/observation'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/06 - global id generation/observation',
        checks=all_checks
    ),
)
