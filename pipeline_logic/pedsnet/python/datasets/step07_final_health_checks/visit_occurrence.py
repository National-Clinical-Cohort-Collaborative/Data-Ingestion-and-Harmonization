...
all_checks = [
    Check(E.primary_key('visit_occurrence_id'), 'Valid global id primary key', on_error='FAIL'),
...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/final/visit_occurrence'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/06 - global id generation/visit_occurrence',
        checks=all_checks
    ),
)
