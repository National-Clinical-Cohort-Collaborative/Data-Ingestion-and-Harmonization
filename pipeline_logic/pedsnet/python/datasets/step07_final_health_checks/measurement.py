...
all_checks = [
    Check(E.primary_key('measurement_id'), 'Valid global id primary key', on_error='FAIL'),
...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/final/measurement'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/06 - global id generation/measurement',
        checks=all_checks
    ),
)
