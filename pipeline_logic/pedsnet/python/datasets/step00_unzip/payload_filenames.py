...
@transform(
    payload_filename=Output("/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/00 - unzipped/payload_filename"),
    zip_file=Input("/UNITE/Data Ingestion & OMOP Mapping/raw_data/Zipped Datasets/site_605_pedsnet_raw_zips"),
)
