...
output_checks = [
    Check(E.primary_key('person_id'), 'Valid cleaned primary key', on_error='WARN')
]
input_checks = [
...
@transform(
    processed=Output(
        "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/02 - clean/person",
        checks=output_checks
    ),
    my_input=Input(
        "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/01 - parsed/person",
        checks=input_checks
    ),
