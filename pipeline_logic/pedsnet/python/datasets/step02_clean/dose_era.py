...
output_checks = [
    Check(E.primary_key('dose_era_id'), 'Valid cleaned primary key', on_error='WARN')
]
input_checks = [
...
@transform(
    processed=Output(
        "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/02 - clean/dose_era",
        checks=output_checks
    ),
    my_input=Input(
        "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/transform/01 - parsed/dose_era",
        checks=input_checks
    ),
