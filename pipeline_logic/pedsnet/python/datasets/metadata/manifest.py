...
@transform(
    processed=Output(
        "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/metadata/manifest",
    ...
    control_map=Input("/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/metadata/control_map")
)
def my_compute_function(ctx, my_input, site_id_df, data_partner_ids, omop_vocab, control_map, processed):
    ...
    if processed_rdd.isEmpty():
        schema = schemas.manifest_schema
