...
domain = "patient_dimension"
regex = "(?i).*/{domain}\.csv".format(domain=domain.upper())


@transform(
    processed=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: ACT/Site 411/transform/01 - parsed/patient_dimension'),
    ...
    errors=Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: ACT/Site 411/transform/01 - parsed/errors/patient_dimension'),
)
