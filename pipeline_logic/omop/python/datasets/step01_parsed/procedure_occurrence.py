...
@transform(
    processed=Output("/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/transform/01 - parsed/procedure_occurrence"),
    payload=Input("/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/transform/00 - unzipped/payload_filename"),
    errors=Output("/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/transform/01 - parsed/errors/procedure_occurrence"),
