...
@transform(
    processed=Output(
        "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/metadata/manifest",
    ...
    control_map=Input("/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/metadata/control_map")
)
