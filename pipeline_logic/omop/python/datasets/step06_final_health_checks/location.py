...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/final/location'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/transform/05 - global id generation/location',
        checks=all_checks
    ),
)
