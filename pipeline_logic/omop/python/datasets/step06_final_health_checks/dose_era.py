...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/final/dose_era'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/transform/05 - global id generation/dose_era',
        checks=all_checks
    ),
)
