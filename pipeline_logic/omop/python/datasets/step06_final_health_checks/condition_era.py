...
@transform_df(
    Output('/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/final/condition_era'),
    my_input=Input(
        '/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/transform/05 - global id generation/condition_era',
        checks=all_checks
    ),
)
