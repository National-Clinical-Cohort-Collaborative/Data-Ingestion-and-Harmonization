...
input_dfs = {domain: Input(path.transform + "06 - global id generation/" + domain) for domain in domains_with_person_id_column}


@transform_df(
    Output(path.transform + "07 - pre clean/pre_clean_removed_person_ids"),
    **input_dfs
)
