...
anchor = "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 605/anchor"
root = anchor[:-len("anchor")]
transform = root + "transform/"
metadata = root + "metadata/"
union_staging = root + "union_staging/"

input_zip = "/UNITE/Data Ingestion & OMOP Mapping/raw_data/Zipped Datasets/site_605_pedsnet_raw_zips"
site_id = "/UNITE/Data Ingestion & OMOP Mapping/raw_data/data partner id tables/Data Partner IDs - Site 605"
...
concept_relationship = "/UNITE/OMOP Vocabularies/concept_relationship"
