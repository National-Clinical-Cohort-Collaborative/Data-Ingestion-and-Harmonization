CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 777/transform/04 - mapping/procedure_occurrence` AS
...
-- procedure 2 procedure
    with procedures as (
        ...
        AND (p.target_domain_id IS NULL or p.target_domain_id NOT IN ('Device', 'Drug', 'Measurement', 'Observation'))
    ),
