CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 777/transform/04 - mapping/condition_occurrence` AS
...
with condition as (
    ...
    AND (c.target_domain_id IS NULL or c.target_domain_id NOT IN ('Device', 'Measurement', 'Meas Value', 'Observation', 'Procedure'))
),
