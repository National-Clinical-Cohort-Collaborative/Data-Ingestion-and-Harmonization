CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 777/transform/04 - mapping/observation` AS  
    ...
    with observation as (
        SELECT
         ...
         AND (o.target_domain_id IS NULL or o.target_domain_id not in ('Measurement'))
    ), 
