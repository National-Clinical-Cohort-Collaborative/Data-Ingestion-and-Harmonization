CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 777/transform/04 - mapping/control_map` AS
    SELECT 
        * 
    ...
    FROM (
        ...
        FROM ( 
            ...
            ( select distinct case_person_id, buddy_num, control_person_id, data_partner_id, payload
                from `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 777/transform/03 - prepared/control_map` cm
