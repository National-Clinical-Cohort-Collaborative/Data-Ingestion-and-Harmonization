...
anchor = "/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: OMOP/Site 25/anchor"
root = anchor[:-len("anchor")]
transform = root + "transform/"
metadata = root + "metadata/"
union_staging = root + "union_staging/"

input_zip = "/UNITE/Data Ingestion & OMOP Mapping/raw_data/Zipped Datasets/site_25_omop_raw_zips"
site_id = "/UNITE/Data Ingestion & OMOP Mapping/raw_data/data partner id tables/Data Partner IDs - Site 25"
