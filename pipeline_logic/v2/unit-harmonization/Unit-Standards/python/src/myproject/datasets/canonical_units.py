...
def my_compute_function(output):
    canonical_units = [
        ...
        {'measured_variable':'BMI','codeset_id':'65622096','omop_unit_concept_id':'9531','omop_unit_concept_name':'kilogram per square meter','max_acceptable_value':'100','min_acceptable_value':'0'},
        ...
        {'measured_variable':'Diastolic blood pressure','codeset_id':'573275931','omop_unit_concept_id':'8876','omop_unit_concept_name':'millimeter mercury column','max_acceptable_value':'200','min_acceptable_value':'0'},
