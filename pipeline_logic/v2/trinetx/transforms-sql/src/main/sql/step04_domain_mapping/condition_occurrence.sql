CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 777/transform/04 - domain mapping/condition_occurrence` AS
...
WITH diagnosis AS (
    SELECT 
        ...
        , cast(date as timestamp) as condition_start_datetime
