CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/04 - domain mapping/person` AS

with patients_with_records AS (
    SELECT DISTINCT patid FROM (
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/condition`		
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/death`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/death_cause`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/diagnosis`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/dispensing`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/encounter`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/immunization`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/lab_result_cm`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/med_admin`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/obs_clin`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/obs_gen`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/prescribing`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/pro_cm`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/procedures`
            UNION ALL
        SELECT DISTINCT patid FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PCORnet/Site 777/transform/03 - prepared/vital`
    )
),
