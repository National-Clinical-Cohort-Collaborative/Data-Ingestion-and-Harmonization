...
from trinetx.trinetx_schemas import complete_domain_schema_dict_string_type, schema_dict_to_struct
from trinetx.site_specific_utils import get_site_dialect_params
...
def parse_input(ctx, my_input: TransformInput, error_df: TransformOutput, site_id: int, domain: str, regex: str):
    ...
    if processed_rdd.isEmpty():
        ...
        schema_dict = complete_domain_schema_dict_string_type[domain]
