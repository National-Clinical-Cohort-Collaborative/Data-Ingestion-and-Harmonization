-- VIEW: V_P2O_PRESCRIBING_CODE_WALK 
-- CDM data source: PCORnet 
-- PROJECT : N3C
-- Description: PRESCRIBING code lookup map to omop concept ids
-- Author: Stephanie Hong
-- Edit Date: JUNE 2, 2020
  

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CDMH_STAGING"."V_P2O_PRESCRIBING_CODE_WALK" ("CDM_TBL", "SRC_CODE", "SRC_CODE_TYPE", "SOURCE_CODE", "SOURCE_CONCEPT_ID", "SOURCE_CODE_DESCRIPTION", "SOURCE_VOCABULARY_ID", "SOURCE_DOMAIN_ID", "TARGET_CONCEPT_ID", "TARGET_CONCEPT_NAME", "TARGET_VOCABULARY_ID", "TARGET_DOMAIN_ID", "TARGET_CONCEPT_CLASS_ID") AS 
  select 'PRESCRIBING' as cdm_tbl, src_code, src_code_type,  
...
SELECT distinct 'PRESCRIBING' as CDM_TBL, p.rxnorm_cui as src_code, 
