-- VIEW: V_P2O_PRESCRIBING_CODE_XWALK 
-- CDM data source: PCORnet 
-- PROJECT : N3C
-- Description: PRESCRIBING code to omop concept ids
-- Author: Stephanie Hong, Clair Blacketer
-- Edit Date: JUNE 3, 2020
  

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CDMH_STAGING"."V_P2O_PRESCRIBING_CODE_XWALK" 
  ...
  select 'PRESCRIBING' as cdm_tbl, src_code, src_code_type,  
    ...
    (
		...
		on source_code in (p.rxnorm_cui ) 
