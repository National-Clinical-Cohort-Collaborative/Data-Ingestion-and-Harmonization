-- N3C DI&H
-- CDM source PCORnet 
-- Diagnosis code xwalk view - dx to omop concept ids
-- Stephanie Hong, Clair Blacketer
-- May 31, 2020

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CDMH_STAGING"."V_P2O_DIAGNOSIS_CODE_XWALK" 
  ...
  (
	...
	(
		...
		where source_vocabulary_id in( 'ICD9CM', 'ICD9Proc', 'ICD10CM', 'ICD10PCS', 'HCPCS', 'SNOMED', 'PCORNet') ---
