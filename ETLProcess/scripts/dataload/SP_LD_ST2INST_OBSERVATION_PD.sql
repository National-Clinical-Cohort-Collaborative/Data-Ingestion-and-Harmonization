...
Stored Procedure : SP_LD_ST2INST_OBSERVATION_PD

Description : Load data from staging to instance

*************************************************************/
CREATE PROCEDURE CDMH_STAGING.SP_LD_ST2INST_OBSERVATION_PD 
(
...
AS
/********************************************************************************************************
     Name:      SP_LD_ST2INST_OBSERVATION_PD
     Purpose:    Loading The CDMH_STAGING.OBSERVATION_PERIOD Table into N3C_Instance.OBSERVATION_PERIOD
     Source:
     Revisions:
...
**************************************************************/
CURSOR OBSERVATION_PERIOD_Cursor IS
SELECT OBSERVATION_PERIOD_ID,
PERSON_ID,
OBSERVATION_PERIOD_START_DATE,
OBSERVATION_PERIOD_END_DATE,
PERIOD_TYPE_CONCEPT_ID
FROM cdmh_staging.ST_OMOP53_OBSERVATION_PERIOD
WHERE DATA_PARTNER_ID=DATAPARTNERID AND MANIFEST_ID=MANIFESTID;
TYPE l_val_cur IS TABLE OF OBSERVATION_PERIOD_Cursor%ROWTYPE;
...
******************************************************/
open OBSERVATION_PERIOD_Cursor;
  LOOP
    FETCH OBSERVATION_PERIOD_Cursor bulk collect into values_rec limit 10000;
    EXIT WHEN values_rec.COUNT=0;
BEGIN
   FORALL i IN 1..values_rec.COUNT
	   INSERT INTO N3C_OMOP531_INSTANCE.OBSERVATION_PERIOD VALUES values_rec(i);
        COMMIT;
	END;
...
COMMIT;
Close OBSERVATION_PERIOD_Cursor;
dbms_output.put_line('Number of records inserted are = '||RECORDCOUNT);

END SP_LD_ST2INST_OBSERVATION_PD;
