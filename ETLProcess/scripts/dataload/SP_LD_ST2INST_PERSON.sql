...
Stored Procedure : SP_LD_ST2INST_PERSON

Description : Load data from staging to instance

*************************************************************/
CREATE PROCEDURE CDMH_STAGING.SP_LD_ST2INST_PERSON 
(
...
AS
/********************************************************************************************************
     Name:      SP_Load_ST2Instance_PERSON
     Purpose:    Loading The CDMH_STAGING.PERSON Table into N3C_Instance.PERSON
     Source:
     Revisions:
...
BEGIN
   FORALL i IN 1..values_rec.COUNT
	   INSERT INTO N3C_OMOP531_INSTANCE.PERSON VALUES values_rec(i);
        COMMIT;
	END;
