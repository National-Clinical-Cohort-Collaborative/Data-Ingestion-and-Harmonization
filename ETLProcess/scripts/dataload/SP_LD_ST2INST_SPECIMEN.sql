...
Stored Procedure : SP_LD_ST2INST_SPECIMEN

Description : Load data from staging to instance

*************************************************************/
CREATE PROCEDURE CDMH_STAGING.SP_LD_ST2INST_SPECIMEN 
(
...
AS
/********************************************************************************************************
     Name:      SP_LD_ST2INST_SPECIMEN
     Purpose:    Loading The CDMH_STAGING.SPECIMEN Table into N3C_Instance.SPECIMEN
     Source:
     Revisions:
...
FROM CDMH_STAGING.ST_OMOP53_SPECIMEN
...
BEGIN
   FORALL i IN 1..values_rec.COUNT
	   INSERT INTO N3C_OMOP531_INSTANCE.SPECIMEN VALUES values_rec(i);
        COMMIT;
	END;
