...
RECORDCOUNT  := observation_recordCount + condition_recordCount+procedure_recordCount+measure_recordCount;
DBMS_OUTPUT.put_line(RECORDCOUNT ||' PCORnet CONDITION source data inserted to condition staging table, ST_OMOP53_CONDITION_OCCURRENCE and observation staging table, ST_OMOP53_OBSERVATION and procedure staging table, ST_OMOP53_PROCEDURE_OCCURRENCE, successfully.');
--
