...
*************************************************************/
CREATE PROCEDURE CDMH_STAGING.SP_DM_OMOP_CARE_SITE 
(
...
'CARE_SITE' AS DOMAIN_NAME,
CARE_SITE_ID AS SOURCE_ID, 
SYSDATE AS CREATE_DATE,
null as target_domain_id, 
null as target_concept_id 
FROM NATIVE_OMOP531_CDM.CARE_SITE
LEFT JOIN CDMH_STAGING.N3CDS_DOMAIN_MAP mp on CARE_SITE.CARE_SITE_ID=Mp.Source_Id 
    AND mp.DOMAIN_NAME='CARE_SITE' AND mp.DATA_PARTNER_ID=DATAPARTNERID 
