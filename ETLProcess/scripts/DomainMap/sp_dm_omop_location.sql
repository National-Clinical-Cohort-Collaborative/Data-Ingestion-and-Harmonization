...
Stored Procedure : SP_DM_OMOP_LOCATION

Description : insert to N3CDS_DOMAIN_MAP

*************************************************************/
CREATE PROCEDURE CDMH_STAGING.SP_DM_OMOP_LOCATION 
(
...
'LOCATION' AS DOMAIN_NAME,
LOCATION_ID AS SOURCE_ID, 
SYSDATE AS CREATE_DATE,
null as target_domain_id, 
null as target_concept_id
FROM "NATIVE_OMOP531_CDM"."LOCATION"  
LEFT JOIN CDMH_STAGING.N3CDS_DOMAIN_MAP mp on LOCATION.LOCATION_ID=Mp.Source_Id
                                          AND mp.DOMAIN_NAME='LOCATION'  
