...
Stored Procedure : SP_DM_OMOP_PROCEDURE_OCCURR

Description : insert to N3CDS_DOMAIN_MAP

*************************************************************/
CREATE PROCEDURE CDMH_STAGING.SP_DM_OMOP_PROCEDURE_OCCURR 
(
...
'PROCEDURE_OCCURRENCE' AS DOMAIN_NAME,
PROCEDURE_OCCURRENCE_ID AS SOURCE_ID, 
SYSDATE AS CREATE_DATE,
null as target_domain_id, 
null as target_concept_id
FROM "NATIVE_OMOP531_CDM"."PROCEDURE_OCCURRENCE"  
JOIN CDMH_STAGING.person_clean ON PROCEDURE_OCCURRENCE.PERSON_ID=person_clean.PERSON_ID 
                            AND PERSON_CLEAN.DATA_PARTNER_ID=DATAPARTNERID   
LEFT JOIN CDMH_STAGING.N3CDS_DOMAIN_MAP mp on PROCEDURE_OCCURRENCE.PROCEDURE_OCCURRENCE_ID=Mp.Source_Id 
                            AND mp.DOMAIN_NAME='PROCEDURE_OCCURRENCE' 
...
END SP_DM_OMOP_PROCEDURE_OCCURR;
